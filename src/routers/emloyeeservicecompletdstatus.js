...
// const { clearQuotelogin } = require('../routers/clearQuotetokenaccess');
const axios = require('axios');

const express = require('express');
const router = new express.Router();

router.post('/employeecompletedstatusupdate', async (req, res) => {
  try {
    // const [
    //   [vehicleData],
    ...
    const [row] = await poolConnection.execute('call ds_employee_completed_status_upload_wash(?,?,?,?,?,?)', [
      req.body.leadId,
      req.body.employeeId,
      req.body.latitude,
      req.body.longitude,
